...
%% Only use this part when have run all the simulations and the data files are available. 
...
% figure(1)
% 
% h(1) = semilogy(1,1,'o','Color',colors(1,:),'MarkerSize',10,'MarkerFaceColor',colors(1,:),'DisplayName','Ni')
% hold on
% h(2) = semilogy(1,1,'s','Color',colors(2,:),'MarkerSize',10,'MarkerFaceColor',colors(2,:),'DisplayName','Fe')
% h(3) = semilogy(1,1,'^','Color',colors(3,:),'MarkerSize',10,'MarkerFaceColor',colors(3,:),'DisplayName','Cr')
% h(4) = semilogy(1,1,'v','Color',colors(4,:),'MarkerSize',10,'MarkerFaceColor',colors(4,:),'DisplayName','Co')
% h(5) = semilogy(1,1,'d','Color','k','MarkerFaceColor',colors(10,:),'MarkerSize',10,'DisplayName','Exp.')
% 
% 
...
% 
% semilogy(10000./T,D02*exp(-3.0./(Pars.kb.*T)),'k--','LineWidth',2.0)
% 
% semilogy(10000./T,0.1e-6*exp(-2.3./(Pars.kb.*T)),'r-','LineWidth',2.0)
% 
% h(5) = semilogy(10000./experiments(:,1),experiments(:,2),'d','Color','k','MarkerFaceColor',colors(10,:),'MarkerSize',10,'DisplayName','Exp.')
% 
% 
...
% set(h,'Rotation',-28);
% h=text(17.5,5e-33,'E_f = 3.0 eV','FontSize',14)
% set(h,'Rotation',-35);
% 
% 
% % Inset
% axes('Position',[.25 .2 .25 .25])
% box on
% 
% semilogy(10000/300,data_300K(data_300K(:,3) == 1,6),'o','Color',colors(1,:),'MarkerFaceColor',colors(1,:))
% hold on
